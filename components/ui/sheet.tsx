...
>(({ side = "right", className, children, hideOverlay, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <SheetPrimitive.Close className="absolute z-50 rounded-sm opacity-70 ring-offset-background transition-all hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none bg-white border border-stone-300 p-2.5 hover:border-stone-400" style={{ left: 'calc(-2.5rem - 2px)', top: '0' }}>
