...
// Legacy interfaces and functions for backwards compatibility with existing destination pages
...
// Legacy function - now reads from TSL_website_content_full.json for backwards compatibility
