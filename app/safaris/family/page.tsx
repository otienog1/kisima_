...
import { familyItinerariesData } from "@/lib/itinerariesData";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
export default function FamilySafarisPage() {
  ...
  const safari = content.family_safaris;
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="text-center mb-12">
            ...
            <p className="font-sofia-pro text-lg text-stone-600 max-w-3xl mx-auto">
              Discover our family-friendly safari adventures with activities for all ages and unforgettable memories.
            </p>
          </div>
          <Carousel
            opts={{
          ...
          >
            <CarouselContent>
              {familyItinerariesData.map((itinerary) => (
                  ...
                  <div className="p-1">
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <Link
                          href={`/safaris/family/${itinerary.id}`}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-sofia-pro text-lg text-stone-300 mb-8">
              Instilling values of conservation and cultural respect
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Section className="py-16 lg:py-24 bg-accent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-screen-xl">
          <h2 className="font-freight-display-pro text-3xl lg:text-4xl font-bold mb-6 text-stone-800">
            Create Unforgettable Family Memories in Africa
          </h2>
          <p className="font-sofia-pro text-lg text-stone-700 mb-8 max-w-2xl mx-auto">
            Let us design a safari that delights every member of your family
          </p>
          <Link
            href="/contact"
