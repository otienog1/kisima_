...
import { connectionItinerariesData } from "@/lib/itinerariesData";

export default function ConnectionSafarisPage() {
  const content = getWebsiteContent();
  const safari = content.connection_safaris;
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="font-freight-display-pro text-3xl lg:text-4xl text-stone-800 mb-6">
                Why Choose Our Connection Safaris
              </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="text-center mb-12">
            <h2 className="font-freight-display-pro text-3xl lg:text-4xl text-stone-800 mb-4">
              Connection Safari Itineraries
            </h2>
            <p className="font-sofia-pro text-lg text-stone-600 max-w-3xl mx-auto">
              Explore journeys designed to reconnect you with your heritage, culture, and ancestral roots.
            </p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            {connectionItinerariesData.map((itinerary) => (
              <div key={itinerary.id} className="space-y-6">
                ...
                <div>
                  ...
                  <Link
                    href={`/safaris/connection/${itinerary.id}`}
      ...
      <Section className="py-16 lg:py-24 bg-accent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-screen-xl">
          <h2 className="font-freight-display-pro text-3xl lg:text-4xl font-bold mb-6 text-stone-800">
            Rediscover Your African Story
          </h2>
          <p className="font-sofia-pro text-lg text-stone-700 mb-8 max-w-2xl mx-auto">
            Let us guide you back to the places that shaped your memories
          </p>
          <Link
            href="/contact"
