  ...
  return (
    <main className="min-h-screen overflow-x-hidden">
      <Hero
        ...
        description="Have questions? Need a custom itinerary? We're here to help you plan your perfect African adventure."
            ...
            <div>
              ...
              <div className="bg-amber-50 p-8 rounded-lg">
                ...
                <p className="font-sofia-pro text-stone-700 mb-6 leading-relaxed">
                  Our safari specialists are ready to help you create the perfect African adventure. From wildlife safaris to cultural experiences, we&apos;ll craft a personalized itinerary just for you.
                </p>
                <div className="space-y-3">
                  {contact.details.map((detail, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-amber-500 rounded-full mt-3"></div>
                      <p className="font-sofia-pro text-stone-700">{detail}</p>
                    </div>
                  ))}
                </div>
              </div>
